...
const AboutUs = () => {
    return (
        <div>
            ...
            <Typography sx={{fontSize: '14px', color: '#395987', mt: '15px'}} variant="caption" display="block" gutterBottom>
                 Home / About Us
            </Typography>
            <Typography sx={{fontSize: '24px', weight: '600px', color: '#395987', mt: '24px'}} variant="h6" gutterBottom component="div">
                About Us
            </Typography>
            <Paper sx={{p: '30px', mt: '24px'}}>
...
Libero metus metus nunc, vestibulum. Accumsan sollicitudin maecenas pulvinar ullamcorper rhoncus sed. Dignissim euismod adipiscing eu viverra sollicitudin pellentesque bibendum amet, arcu. Tempus, mattis lobortis diam, arcu. Lectus dignissim pretium congue nulla proin duis ut duis vehicula. Lectus lacinia sollicitudin ultrices ipsum pellentesque semper auctor. Amet suspendisse at nisl sit turpis. Morbi vel dis aliquam faucibus urna magna semper lorem eget. Purus proin id sit egestas adipiscing et id. Ullamcorper viverra mauris vitae nulla.
                ...
                <Grid item xs={8}>
                <div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.9109475031933!2d77.6494563148214!3d12.913444890894139!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1482cdcd9c37%3A0x9b8e07dfe1013332!2sIgnitarium%20Technology%20Solutions%20Private%20Limited!5e0!3m2!1sen!2sbd!4v1653802064430!5m2!1sen!2sbd" width="650" height="500" style={{border: 0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                </Grid>
                <Grid item xs={4}>
                    <Box>
                <Typography sx={{fontSize: '18px', weight: '600px', color: '#395987'}} variant="h6" gutterBottom component="div">
                    Heading Goes Here
                    </Typography>
                <Typography sx={{fontSize: '14px', weight: '400px', maxWidth: '252px', lineHeight: '28px', color: '#333333'}} gutterBottom component="div">
                2615, 3rd Floor, 
            ...
            <Grid container spacing={2} sx={{mt: '40px'}}>
                    <Grid item xs={6} md={2}>
                        <Typography sx={{fontSize: '14px', weight: '600px', color: '#333333', mt: '40px'}} variant="h6" gutterBottom component="div">
                        Jobs by Locations
                        </Typography>
                        <Typography sx={{fontSize: '14px', weight: '600px', color: '#333333', mt: '40px'}} variant="h6" gutterBottom component="div">
                    ...
                    <Typography sx={{fontSize: '14px', weight: '100px', color: '#4F4F4F', mt: '40px'}} gutterBottom component="div">
