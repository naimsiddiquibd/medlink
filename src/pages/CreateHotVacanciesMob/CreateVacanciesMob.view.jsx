...
const CreateVacanciesMob = () => {
  ...
  const handleCreateVacancy = () => {
    ...
    console.log("Read Query:", QUERY_CREATEHOTVACANCY)
              ...
              >
                ...
                >
                  ...
                  >
                    <FormControl fullWidth>
                      <Typography variant="p" sx={{ textAlign: "left", mb: 1 }}>
                        Job Title
                ...
                <Grid container spacing={2}>
                  ...
                  >
                    ...
                    <Button onClick={handleCreateVacancy} variant="contained" sx={{ width: "100%" }}>
                      Create
                    </Button>
                  </Grid>
                </Grid>
