...
const CareerProfile = () => {
  ...
  const CareerScreen = (item) => {
    ...
    values.expectedSalary = [careerItem?.expectedSalaryStart , careerItem?.expectedSalaryEnd]
  };
                        ...
                        > */}
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  {careerItem?.expectedSalaryStart} {" "} {"lakh INR"} {" - "} {careerItem?.expectedSalaryEnd} {" "} {"lakh INR"}
                                </Typography>
                              </Box>
              ...
              <Grid item sx={{ marginBlock: "1rem" }} spacing={2}>
                ...
                >
                  ...
                  <Slider
                        ...
                        // value={careerItem.expectedSalary}
                        defaultValue={[careerItem.expectedSalaryEnd, careerItem.expectedSalaryStart]}
                        min={1}
                        max={99}
                        // marks = { mark1}
                        marks={ [
                           { value: 1, label: `${(Math.round((values.expectedSalary[0])))} lakh INR` },
                          { value: 99, label: `${(Math.round((values.expectedSalary[1])))} lakh INR` }, 
                        ]} 
                        sx={{
                            "& .MuiSlider-thumb": {
                                height: 24,
                  ...
                  {values.expectedSalary === "" && (
                    ...
                    <Grid>
                      <FormLabel component="legend" sx={{ mt: 2 }}>
                        <span style={{ color: '#616161' }}>Communication Preference</span>
                      </FormLabel>
