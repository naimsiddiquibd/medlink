...
const PersonalDetailsMob = () => {
  ...
  if (!isLoading) {
    return (
      <Grid item sx={{ px: 2 }} spacing={2}>
        {!flag && !lang && !isUpdateLang && (
          <Grid personalDetailsData sx={{}} spacing={2}>
            <Card
              sx={{
                height: "100%",
                backgroundColor: "",
                  ...
                  <div>
                    <div>
                      <CardContent sx={{ display: "flex" }}>
                        ...
                        >
                          <Box
                            sx={{ display: "flex", gap: 3, color: "#828282", ml: -2 }}
                          >
                            <Typography
                              variant="subtitle2"
                    ...
                    <div>
                      <div>
                        ...
                        >
                          <tr>
                            <th>
                              <Typography variant="info" sx={thStyle}>
                                Languages
                              </Typography>
                            </th>
                            <th>
                              <Typography variant="info" sx={thStyle}> Proficiency  </Typography>
                            </th>
                            <th>
                              <Typography variant="info" sx={thStyle}> Read </Typography>
                            </th>
                            <th>
                              <Typography variant="info" sx={thStyle}> Write </Typography>
                            </th>
                            <th>
                              <Typography variant="info" sx={thStyle}> Speak </Typography>
                            </th>
                          </tr>
...
export default PersonalDetailsMob;

const textStyle = { fontSize: 12, color: "#828282" };
const thStyle = { fontSize: 14, color: "#828282", mr: 1, fontWeight: 500 };
